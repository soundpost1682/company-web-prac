...
const AdminPosts = () => {
  ...
  return (
    <div className="p-4 mx-auto max-w-[1700px]">
      <h1 className="text-4xl font-bold mt-6 mb-4">Manage Q&A</h1>
                ...
                <td className="px-4 py-3 text-center">
                  {
                    post.fileUrl.length >0? (
                      post.fileUrl.map((url, index)=>(
                        <button key={index} className="inline-flex items-center gap-1 px-3 py-1.5 bg-gray-50 hover:bg-gray-100 text-gray-700 text-sm rounded-md transition-all duration-300 border-gray-200 hover:border-gray-300 mr-2">
                          File {index+1}
                        </button>
                      ))
                    ): (

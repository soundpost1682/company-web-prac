  ...
  return (
    <div className="container max-w-7xl mx-auto px-4 py-32">
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-gray-600">something going on</p>
      </div>
      ...
      <div className="flex flex-col md:flex-row gap-12 mb-24 items-center">
        <div className="md:w-2/3">
          ...
          <div className="text-lg text-gray-600 space-y-6">
            <p>Greetings, dremifa CEO here</p>
            <p>
            ...
            <p className="font-semibold mt-8">doremifa Solar System CEO</p>
          </div>
        </div>
        <div className="md:w-1/3">
          <div className="rounded-xl overflow-hidden shadow-lg">
            ...
            <div className="p-4 bg-white">
              <h3 className="text-xl font-bold text-gray-800">Lee</h3>

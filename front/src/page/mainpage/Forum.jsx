    ...
    <div className="bg-white">
      <div className="container mx-auto px-4 py-28 lg:py-0 max-w-6xl">
        ...
        <div className="flex justify-end mb-4">
          <Link
            to="/"
            className="px-5 py-2 bg-white text-green-900 rounded-lg hover:bg-gray-100 transition-colors duration-300 flex items-center gap-2 border border-gray-200"
        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden">
          {dummyPosts.length === 0 ? (
            <div className="p-6 text-center text-gray-500">No recent posts</div>
          ) : (
            dummyPosts.map((post) => (
              <div
                key={post._id}

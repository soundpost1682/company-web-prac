...
import companyImg from "../../assets/Image2.jpg";
  ...
  return (
    <div className="container mx-auto px-4 py-32 max-w-7xl">
      <div className="relative rounded-2xl overflow-hidden shadow-2xl mb-24">
        ...
        <div className="absolute bottom-8 left-8 md:bottom-12 md:left-12 text-white">
          ...
          <p className="text-base md:text-xl font-light">
            Lead market with innovation and trust
          </p>
        </div>
      </div>
      ...
      <div className="mb-24 max-w-4xl mx-auto text-center">
        <h2 className="text-4xl font-bold mb-8 text-slate-800">Vision</h2>
        <p className="text-2xl leading-relaxed text-gray-600">
          asodijasoidjasdioj qwesdfxcvdcgfhsdgf
        </p>
      </div>

      <div className="mb-24">
        <div className="text-4xl font-bold mb-12 text-slate-800 text-center">
          History
        </div>
          ...
          {[
            ...
            >
              <div className="w-1/2 text-center">
                <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-2xl transition-all duration-300 border border-gray100">
